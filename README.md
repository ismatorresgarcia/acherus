...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18864577.svg)](https://doi.org/10.5281/zenodo.18864577)
...
## Citing `acherus`
🔖 All `acherus` releases are linked automatically to a [Zenodo](https://doi.org/10.5281/zenodo.18864577) publication under a unique [DOI](https://doi.org/10.5281/zenodo.18864577). If you use `acherus` in your work, please star this [repository](https://github.com/ismatorresgarcia/acherus) so we can track adoption and improve the project. Additionally, if you use `acherus` in a scientific publication, please consider citing this work:
