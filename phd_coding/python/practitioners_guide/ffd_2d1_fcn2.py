...
matrix_cnt_4 = MATRIX_CNT_2 + fourier_coeff
matrix_cnt_5 = MATRIX_CNT_3 - fourier_coeff
...
for k in tqdm(range(N_STEPS)):
    ...
    for l in range(N_TIME_NODES):
        ...
        right_cn_matrix.setdiag(matrix_cnt_4[l])
        left_cn_matrix.setdiag(matrix_cnt_5[l])
